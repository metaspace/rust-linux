...
impl mq::Operations for AdminQueueOperations {
    ...
    fn new_request_data(
        tagset_data: <Self::TagSetData as kernel::ForeignOwnable>::Borrowed<'_>,
    ...
    fn queue_rq(
        hw_data: <Self::HwData as kernel::ForeignOwnable>::Borrowed<'_>,
        queue_data: <Self::QueueData as kernel::ForeignOwnable>::Borrowed<'_>,
        rq: &mq::Request<Self>,
        is_last: bool,
    ) -> Result {
    ...
    fn commit_rqs(
        queue: <Self::HwData as kernel::ForeignOwnable>::Borrowed<'_>,
        _ns: <Self::QueueData as kernel::ForeignOwnable>::Borrowed<'_>,
    ) {
...
impl mq::Operations for IoQueueOperations {
    ...
    fn new_request_data(data: ArcBorrow<'_, DeviceData>) -> Result<NvmeRequest> {
        Ok(NvmeRequest {
            dma_addr: AtomicU64::new(!0),
            result: AtomicU32::new(0),
            status: AtomicU16::new(0),
    ...
    fn poll(queue: ArcBorrow<'_, NvmeQueue<Self>>) -> i32 {
    ...
    fn map_queues(tag_set: &mq::TagSetRef) -> Result {
        ...
        unsafe {
            let device_data: Self::TagSetData =
                Self::TagSetData::from_foreign((*tag_set.ptr()).driver_data);
