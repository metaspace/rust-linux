...
impl<T: Operations> GenDisk<T> {
    ...
    pub fn try_new(tagset: Arc<TagSet<T>>, queue_data: T::QueueData) -> Result<Self> {
        ...
        let gendisk = from_err_ptr(unsafe {
            bindings::__blk_mq_alloc_disk(tagset.raw_tag_set(), data.cast_mut(), lock_class_key.as_ptr())
        })?;
        ...
        const TABLE: bindings::block_device_operations = bindings::block_device_operations {
            ...
            get_unique_id: None,
            owner: core::ptr::null_mut(), // TODO: Set to THIS_MODULE. Waiting for const_refs_to_static feature to be merged
